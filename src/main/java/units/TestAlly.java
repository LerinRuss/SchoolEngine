...
public class TestAlly extends Creature{
	AI ai = new Calm();
	@Override
	public void action(Iterator<Creature> it) {
		...
		ai = ai.doing(this,Main.creatures.getEnemies());
		if(target != null){
			move();
		}
	}
	 ...
	 */
	public TestAlly clone() throws CloneNotSupportedException{
		return (TestAlly)super.clone();
	}
}
